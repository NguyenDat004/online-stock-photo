...
function Wallet() {
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#0a0e27" }}>
        <div style={{ textAlign: "center" }}>
          <div className="spinner-border" style={{ width: "3rem", height: "3rem", color: "#6c5ce7" }}></div>
          <p style={{ marginTop: "20px", color: "#a29bfe", fontSize: "16px" }}>Đang tải ví của bạn...</p>
        </div>
      </div>
    );
  }
  ...
  const totalIncome = transactions.filter(t => t.type === 'earn').reduce((sum, t) => sum + Number(t.amount), 0);
  const totalWithdraw = transactions.filter(t => t.type === 'withdraw').reduce((sum, t) => sum + Number(t.amount), 0);
    ...
    <div style={{ minHeight: "100vh", background: "#0a0e27", padding: "40px 20px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "40px", textAlign: "center" }}>
          <h1 style={{ color: "white", fontSize: "36px", fontWeight: "700", marginBottom: "10px" }}>
            Ví của tôi
          </h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "20px", marginBottom: "30px" }}>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "14px", marginBottom: "10px", fontWeight: "500" }}>
                SỐ DƯ KHẢ DỤNG
              </p>
              <h2 style={{ color: "white", fontSize: "32px", fontWeight: "700", margin: "0 0 20px" }}>
                {formatMoney(balance)}
              </h2>
              <button 
        ...
        <div style={{
          ...
          {transactions.length === 0 ? (
            <div style={{ 
              ...
              <div style={{ fontSize: "5rem", marginBottom: "20px", filter: "grayscale(1)", opacity: 0.5 }}>📭</div>
              <h5 style={{ color: "#a29bfe", fontSize: "18px", marginBottom: "10px" }}>
